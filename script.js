$(document).ready(function() {
  ...
  function on_Button3_click() {
    try {
      // Block#: 18
      com.fc.JavaScriptDistLib.Screen.setProperty["width"]("MainScreen", (com.fc.JavaScriptDistLib.Screen.getProperty["width"]("MainScreen") + 50)); // Block#: 22
  ...
  function on_Button4_click() {
    try {
      // Block#: 31
      com.fc.JavaScriptDistLib.Screen.setProperty["height"]("MainScreen", (com.fc.JavaScriptDistLib.Screen.getProperty["height"]("MainScreen") + 50)); // Block#: 35
  ...
  function on_Button10_click() {
    try {
      // Block#: 47
      com.fc.JavaScriptDistLib.Screen.setProperty["width"]("MainScreen", (com.fc.JavaScriptDistLib.Screen.getProperty["width"]("MainScreen") - 50)); // Block#: 51
      com.fc.JavaScriptDistLib.Label.setProperty["Text"]("Label5", (String('WIDTH :  ') + String(com.fc.JavaScriptDistLib.TextLib.convertToText(com.fc.JavaScriptDistLib.Screen.getProperty["width"]("MainScreen")))));
    } catch(e) {
      com.fc.JavaScriptDistLib.handleExceptionNative(e);
    }
  ...
  function on_screen_showScreen2() {
    try {
      // Block#: 237
      com.fc.JavaScriptDistLib.Label.setProperty["Text"]("Label10", 'Screen2 shown!'); // Block#: 115
      com.fc.JavaScriptDistLib.Screen.setProperty["Background color"]("Screen2", '#33ff33');
    } catch(e) {
      com.fc.JavaScriptDistLib.handleException(e);
    }
  };
  ...
  function on_screen_showScreen3() {
    try {
      // Block#: 239
      com.fc.JavaScriptDistLib.Label.setProperty["Text"]("Label11", 'Screen3 shown!'); // Block#: 131
  ...
  function on_screen_hideScreen2() {
    try {
      // Block#: 233
      com.fc.JavaScriptDistLib.Label.setProperty["Text"]("Label10", 'Screen2 has been hidden'); // Block#: 140
  ...
  function on_Button8_click() {
    try {
      // Block#: 57
      com.fc.JavaScriptDistLib.Screen.setProperty["height"]("MainScreen", (com.fc.JavaScriptDistLib.Screen.getProperty["height"]("MainScreen") - 50)); // Block#: 61
      com.fc.JavaScriptDistLib.Label.setProperty["Text"]("Label6", (String('HEIGHT :  ') + String(com.fc.JavaScriptDistLib.TextLib.convertToText(com.fc.JavaScriptDistLib.Screen.getProperty["height"]("MainScreen")))));
    } catch(e) {
      com.fc.JavaScriptDistLib.handleExceptionNative(e);
    }
  ...
  let on_screen_back_button_pressScreen4 = function() {
    try {
      // Block#: 147
      com.fc.JavaScriptDistLib.Screen.setProperty["Background color"]("Screen4", '#ffffff'); // Block#: 149
  ...
  function on_screen_showScreen4() {
    try {
      // Block#: 241
      com.fc.JavaScriptDistLib.Label.setProperty["Text"]("Label12", 'Screen4 shown!'); // Block#: 231
  ...
  function on_Button5_click() {
    try {
      // Block#: 67
      com.fc.JavaScriptDistLib.Screen.setProperty["x"]("MainScreen", (com.fc.JavaScriptDistLib.Screen.getProperty["x"]("MainScreen") + 50)); // Block#: 71
  ...
  function on_screen_hideScreen4() {
    try {
      // Block#: 244
      com.fc.JavaScriptDistLib.Label.setProperty["Text"]("Label12", 'Screen4 has been hidden'); // Block#: 246
  ...
  function on_screen_orientation_changeMainScreen(new_orientation) {
    try {
      // Block#: 228
      com.fc.JavaScriptDistLib.Label.setProperty["Text"]("Label9", 'ORIENTATION CHANGED: RESET all properties! '); // Block#: 180
      com.fc.JavaScriptDistLib.Screen.setProperty["x"]("MainScreen", 172); // Block#: 203
      com.fc.JavaScriptDistLib.Screen.setProperty["y"]("MainScreen", 100); // Block#: 205
      com.fc.JavaScriptDistLib.Screen.setProperty["width"]("MainScreen", 480); // Block#: 207
      com.fc.JavaScriptDistLib.Screen.setProperty["height"]("MainScreen", 800); // Block#: 209
      com.fc.JavaScriptDistLib.Screen.setProperty["Background image"]("MainScreen", ('img/blank_image.svg')); // Block#: 178
  ...
  function on_Button6_click() {
    try {
      // Block#: 77
      com.fc.JavaScriptDistLib.Screen.setProperty["y"]("MainScreen", (com.fc.JavaScriptDistLib.Screen.getProperty["y"]("MainScreen") + 50)); // Block#: 81
  ...
  function on_screen_orientation_changeScreen2(new_orientation) {
    try {
      // Block#: 251
      com.fc.JavaScriptDistLib.Label.setProperty["Text"]("Label10", 'ORIENTATION CHANGED:  RESET all properties! '); // Block#: 266
  ...
  function on_screen_orientation_changeScreen3(new_orientation) {
    try {
      // Block#: 269
      com.fc.JavaScriptDistLib.Label.setProperty["Text"]("Label11", 'ORIENTATION CHANGED:  RESET all properties! '); // Block#: 271
  ...
  function on_Button11_click() {
    try {
      // Block#: 87
      com.fc.JavaScriptDistLib.Screen.setProperty["x"]("MainScreen", (com.fc.JavaScriptDistLib.Screen.getProperty["x"]("MainScreen") - 0)); // Block#: 91
      com.fc.JavaScriptDistLib.Label.setProperty["Text"]("Label7", (String('X :  ') + String(com.fc.JavaScriptDistLib.TextLib.convertToText(com.fc.JavaScriptDistLib.Screen.getProperty["x"]("MainScreen")))));
    } catch(e) {
      com.fc.JavaScriptDistLib.handleExceptionNative(e);
    }
  ...
  function on_screen_orientation_changeScreen4(new_orientation) {
    try {
      // Block#: 274
      com.fc.JavaScriptDistLib.Label.setProperty["Text"]("Label12", 'ORIENTATION CHANGED:  RESET all properties! '); // Block#: 276
      com.fc.JavaScriptDistLib.Screen.setProperty["Background color"]("Screen3", '#ffffff');
    } catch(e) {
      com.fc.JavaScriptDistLib.handleException(e);
    }
  ...
  function on_Button12_click() {
    try {
      // Block#: 97
      com.fc.JavaScriptDistLib.Screen.setProperty["y"]("MainScreen", (com.fc.JavaScriptDistLib.Screen.getProperty["y"]("MainScreen") - 50)); // Block#: 101
      com.fc.JavaScriptDistLib.Label.setProperty["Text"]("Label8", (String('Y :  ') + String(com.fc.JavaScriptDistLib.TextLib.convertToText(com.fc.JavaScriptDistLib.Screen.getProperty["y"]("MainScreen")))));
    } catch(e) {
      com.fc.JavaScriptDistLib.handleExceptionNative(e);
    }
